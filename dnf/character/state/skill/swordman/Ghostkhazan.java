...
public class Ghostkhazan extends BuffActor {
	private boolean right = true;
	private float delta = 0;
	private RoleAnimation an1 = null;
	//private RoleAnimation an2 = null;
	public Ghostkhazan(Character ch, float duringtime) {
		super(ch, 1, new Vector2(100, 0), new Vector2(500, 0), duringtime);
		right = ch.isRight();
		buffstr = "dnf.character.state.buff.swordman.Khazan";
		if(ch.inInstance()) {
			Img img1 = ch.getGame().getImg(SetSwordmanSkill.ghost, "ghostkhazan1.img");
